...
1. [[pre-processing]](./code/cervix-part-crop-GMM-Method-on-train-additional-train-and-test-set.ipynb) Due to big image (`4000*4000`, etc), I resize the original images to fixed size (`224*224`) and crop out the no-relevant part.
